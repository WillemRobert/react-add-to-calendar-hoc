...
function AddToCalendar(WrappedButton, WrappedDropdown) {
  ...
  function (_Component) {
    ...
    function AddToCalendarWrapped() {
      ...
      }), _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getLinkImageClassName", function (sharedSite) {
        switch (sharedSite) {
    ...
    _createClass(AddToCalendarWrapped, [{
      ...
      value: function render() {
        ...
        return _react.default.createElement("div", {
          ...
          }), showIcons && _react.default.createElement("i", {
            className: _this2.getLinkImageClassName(item)
          }), item);
        })));
      }
    }]);
    ...
    items: _propTypes.default.arrayOf(_propTypes.default.oneOf(Object.keys(_enums2.SHARE_SITES).map(function (itm) {
      return _enums2.SHARE_SITES[itm];
    }))),
    ...
    dropdownProps: {},
    filename: 'download',
    items: Object.keys(_enums2.SHARE_SITES).map(function (itm) {
      return _enums2.SHARE_SITES[itm];
    }),
    linkProps: {},
    showIcons: false
